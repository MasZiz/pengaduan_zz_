                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="card shadow-lg border-0 rounded-lg mt-6">
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?= base_url('auth_zz/registrasi'); ?>">
                                        <div class="row mb-3">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    ...
                                                    <input class="form-control" id="nama" type="text" name="nama" value="<?= set_value('nama'); ?>" />
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <input class="form-control" id="nik" type="number" name="nik" value="<?= set_value('nik'); ?>" />
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="<?= base_url('auth_zz') ?>">Have an account? Go to login</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
