...
(1, 'Azizah ganteng tenan cuakzzzzzz');
...
(4, '321321312312', 'admin', 'admin', '$2y$10$IjhrkatLqtr7gB0PB9yBp.nGhPmG1P1kbzpXF6qXtg/i1SigWlj/W', '123', 1, 1),
(5, '321321312312', 'aziz', 'masyarakat', '$2y$10$4e5qYOj3nMxjdlilfsDww.ljYtvo27KcF4dTpEZAgt8Soa8KJqLrW', '123', 1, 3);
...
(6, 'admin', 'admin', '$2y$10$Cd6KX2dWo5DCSvXTJ3DGFueQzkEKGM8iEcXiQfD/OfLrykNnwG9Hq', '123', 'admin');
...
(1, 5, '2023-03-06', 'halw', 0),
(2, 6, '2023-03-06', 'g', 0),
(3, 0, '2023-03-06', '', 0),
(4, 7, '2023-03-06', 'oioioi', 0);
